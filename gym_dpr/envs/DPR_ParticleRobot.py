...
# BOT_ELASTICITY = 0.1
# BOT_FRICTION = 100 # guess -> g*cm/s^2
#  #
...
# BOT_MAX_FORCE = PADDLE_LENGTH * PADDLE_WIDTH * PADDLE_MASS * MAX_ACCELERATION * 2  # g*cm/s^2 # 195312.5
# # BOT_MAX_FORCE = PADDLE_MASS * MAX_ACCELERATION * 2  # g*cm/s^2
# PADDLE_SPEED = 25   # cm/s

# MAGNETIC_FORCE = 90000000 # 146484.4 # guess
# PADDLE_FRICTION = 1000 # guess
...
# BOT_ELASTICITY = 0.1
# BOT_FRICTION = 1 # 100
# BOT_MAX_FORCE = 1000 # 195312.5 # 1562.5
# MAGNETIC_FORCE = 750
...
class CircularBot(ParticleRobot):
    ...
    def observeSelf(self):
        ...
        '''
        # # EDITED -> Added update call (LINE 246 & COMMIT AUG 5TH)
        # self.updateCOM()
        return self.body.position[0], self.body.position[1], self.body.velocity[0], self.body.velocity[1]
        # return self.body.position[0] / 1000, self.body.position[1] / 1000, self.body.velocity[0] / 10, self.body.velocity[1]  / 10
